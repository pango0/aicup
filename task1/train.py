...
t1_train_transcription_file = "/tmp2/zion/AICup/phase1/en/task1_answer.txt"
...
training_args = Seq2SeqTrainingArguments(
  output_dir="whisper-large-v3-turbo-en",
  report_to="none",
  num_train_epochs=1,
  ...
  logging_dir="whisper-large-v3-turbo-en/logs",
  logging_steps=5,
  fp16=True,
  learning_rate=8e-6,
  warmup_ratio=0.1,
...
save_directory = "whisper-large-v3-turbo-en"
