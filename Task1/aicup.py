...
def transcribe_with_timestamps(sample, model, processor):
    ...
    # 2. Preprocess audio with attention mask
    ...
    # 5. Process segments with robust error handling
    segments = []
    
    # First try to get word-level segments
    ...
    # If we got segments but they're too long
