...
def main():
     parser = argparse.ArgumentParser(description="Split training json to different categories")
     parser.add_argument("--input_file", default="original_data_split.json", help="Original JSON file")
     parser.add_argument("--output_dir", default="train_split", help="Directory to save extended file")
     args = parser.parse_args()

     os.makedirs(args.output_dir, exist_ok=True)
     train_data = load_json_file(args.input_file)
     ...
     for category_name, category_dict in categories.items():
          ...
          output_file = f'./{args.output_dir}/train_{category_name}.json'
